...
checklist = ['87.250.250.242', '104.21.25.182', '8.8.8.8', '8.8.4.4', '192.168.0.1', '85.26.252.2', '10.1.1.1-10.1.1.2', '192.168.120.1-2']
...
for_ip_table = ping_ip_addresses(for_ping_check)
	
	
def print_ip_table(value_for_table):	
	d_keys = ['Pingable IPs', 'Unpingable IPs']
	dict_ip_table = dict.fromkeys(d_keys)
	dict_ip_table['Pingable IPs'] = value_for_table[0]
	dict_ip_table['Unpingable IPs'] = value_for_table[1]
	return dict_ip_table
	 
print('\n')
print(tabulate(print_ip_table(for_ip_table), headers = 'keys'))
print('\n')
